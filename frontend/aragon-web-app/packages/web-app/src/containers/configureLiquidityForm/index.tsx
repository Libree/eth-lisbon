...
const ConfigureLiquidityForm: React.FC<ConfigureWithdrawFormProps> = ({
  actionIndex,
}) => {
    ...
    <>
      ...
      <FormItem>
        <Label
          ...
          helpText={'Token address in the pool pair'}
        />
        <Controller
          name={`actions.${actionIndex}.token0Addrress`}
          control={control}
          defaultValue=""
          rules={{
      ...
      <FormItem>
        ...
        />
        <Controller
          name={`actions.${actionIndex}.token1Adress`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      <FormItem>
        <Label
          ...
          helpText={'Amount of token 0 to deposit in the pool'}
        />
        <Controller
          name={`actions.${actionIndex}.token0Amount`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      < FormItem >
        <Label
          ...
          helpText={'Amount of token 1 to deposit in the pool'}
        />
        <Controller
          name={`actions.${actionIndex}.token1Amount`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      < FormItem >
        <Label
          label={'Min price'}
          helpText={'Min limit in price range to set'}
        />
        <Controller
          name={`actions.${actionIndex}.minPrice`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      < FormItem >
        <Label
          label={'Max price'}
          helpText={'Max limit in price range to set'}
        />
        <Controller
          name={`actions.${actionIndex}.maxPrice`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      < FormItem >
        <Label
          label={'Fees collection frecuency (days)'}
          helpText={'How often do you want to collect fees?'}
        />
        <Controller
          name={`actions.${actionIndex}.feesDays`}
          control={control}
          defaultValue=""
          rules={{
          }}
...
export default ConfigureLiquidityForm;
