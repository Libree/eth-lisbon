...
import ReviewLoan from 'containers/reviewLoan';
...
const AcceptLoanRequest: React.FC = () => {
    ...
    <>
      <FormProvider {...formMethods}>
        <ActionsProvider daoId={daoDetails?.address as string}>
          ...
          >
            <FullScreenStepper
              wizardProcessName={'Fund Loand'}
              navLabel={'Initiate loan funding'}
            ...
            >
              <Step
                wizardTitle={'Initiate loan funding'}
                wizardDescription={'To accept a loan, your proposal will need to pass a vote'}
              ...
              >
                <ReviewLoan action={defaultValues.actions[0]}/>
              </Step>
              <Step
...
export default withTransaction('AcceptLoanRequest', 'component')(AcceptLoanRequest);
