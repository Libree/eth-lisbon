...
import ConfigureLoanRequestForm from 'containers/configureLoanRequest';
    ...
    <>
      <FormProvider {...formMethods}>
        <ActionsProvider daoId={daoDetails?.address as string}>
          ...
          >
            <FullScreenStepper
              wizardProcessName={'Loan request'}
              navLabel={'Initiate loan request'}
            ...
            >
              <Step
                wizardTitle={'Initiate loan request'}
                wizardDescription={'To request a loan, your proposal will need to pass a vote'}
              ...
              >
                <ConfigureLoanRequestForm actionIndex={0} />
              </Step>
              <Step
...
export default withTransaction('NewLoanRequest', 'component')(NewLoanRequest);
