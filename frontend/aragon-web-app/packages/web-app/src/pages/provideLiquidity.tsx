...
import ConfigureLiquidityForm from 'containers/configureLiquidityForm';
    ...
    <>
      <FormProvider {...formMethods}>
        <ActionsProvider daoId={daoDetails?.address as string}>
          ...
          >
            <FullScreenStepper
              wizardProcessName={'Provide Liquidity'}
              navLabel={'Provide liquidity to Uniswap pool'}
            ...
            >
              <Step
                wizardTitle={'Provide Liquidity'}
                wizardDescription={'To provide liquidity to Uniswap pool, your proposal will need to pass a vote'}
              ...
              >
                <ConfigureLiquidityForm actionIndex={0} />
              </Step>
              <Step
